...
void on_conn_params_evt(ble_conn_params_evt_t * p_evt)
{
    ...
    if(user_conn_params_event != NULL)
    	user_conn_params_event(p_evt);
}
...
void conn_params_error_handler(uint32_t nrf_error)
{
    ...
    if(user_conn_params_err_handler != NULL)
    	user_conn_params_err_handler(nrf_error);
}
...
void on_ble_event(ble_evt_t const * p_ble_evt, void * p_context)
{
    ...
    if(user_ble_event != NULL)
        user_ble_event(p_ble_evt, p_context);
